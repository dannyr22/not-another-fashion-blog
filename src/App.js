...
function App() {
  const cards = [
    ...
    {title: 'Deadly Beavers', image: 'https://ychef.files.bbci.co.uk/624x351/p04b1gkk.jpg', name: 'Fish Fingers', body: 'Beavers are being introduced back to the U.K BEWARE THEY WILL EAT YOU', avatar: 'https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1349&q=80', avatarName: 'William Conquer', dateCreated: 'July 22nd 1066'},
    ...
    {title: 'Magic Sock puppets', image: 'https://masandpas.com/wp-content/uploads/2020/04/socks-main-3-new.jpg', name: 'Magic Sock Puppets Found in Serbia', body: 'Magic sock puppets have been found in Serbia, not many people have lived to see them but those that have are never going back!', avatar: 'https://www.bestyears.co.uk/images/stories/virtuemart/product/rsz_utn_carrot_toy.jpg', avatarName: 'Buffy Summers', dateCreated: 'June 2nd 1969'},
  ]
